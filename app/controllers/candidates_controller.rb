class CandidatesController < ApplicationController
  ...
  CONSTITUENCY_LIST = {
    ...
    "aberdeen" => [ "Aberdeen North-north",14398 ],
    "aberdeen" => [ "Aberdeen South-south",14399 ],
    "airdrie" => [ "Airdrie and Shotts-and-shotts",14400 ],
    "aldershot" => [ "Aldershot",65730 ],
    "aldridge" => [ "Aldridge-Brownhills-brownhills",65773 ],
    "altrincham" => [ "Altrincham and Sale West-and-sale-west",65892 ],
    "alyn" => [ "Alyn and Deeside-and-deeside",66103 ],
    "amber" => [ "Amber Valley-valley",65809 ],
    "angus" => [ "Angus",14401 ],
    "arfon" => [ "Arfon",66108 ],
    "argyll" => [ "Argyll and Bute-and-bute",14402 ],
    "arundel" => [ "Arundel and South Downs-and-south-downs",65784 ],
    "ashfield" => [ "Ashfield",65895 ],
    "ashford" => [ "Ashford",65811 ],
    "ashton" => [ "Ashton-under-Lyne-under-lyne",66056 ],
