class CandidatesController < ApplicationController
  ...
  PARTY_CONSTANTS = { 
    'Conservative Party' => { 
      'The NHS' => [ [ '£8bn more funding (over inflation) for the NHS by 2020. Ensure everyone can see a GP 7 days a week by 2020. Restore the right to see a specific GP.', 'https://www.conservatives.com/manifesto' ] ],
      'Economy and taxes' => [ [ 'No raises to VAT, National Insurance contributions or Income tax. Increase the tax-free Personal Allowance to £12.5k and the 40p Income Tax threshold to £50k. Balance the structural current budget by 2017–18.', 'https://www.conservatives.com/manifesto' ] ],
      'Immigration' => [ [ 'No jobseeker benefits for EU migrants, and earnings required for other benefits. Cap for skilled economic migration from outside the EU. Toughen requirements, including language tests, for non-EU spouses joining EU citizens and those coming to UK on family visa.', 'https://www.conservatives.com/manifesto' ] ],
      'Benefits and pensions' => [ [ 'Cap benefits for any household to £23k, and freeze working age benefits for two years. Introduce tax-free childcare and give working parents of 3 and 4-year-olds 30 hours of free childcare a week. Bring in a Single Tier Pension from April 2016, effectively abolishing means-testing pensions of people who have contributed all their lives.', 'https://www.conservatives.com/manifesto' ] ],
      'Law and order' => [ [ 'Give English MPs a veto over matters only affecting England. Scrap the Human Rights Act, breaking the formal link between British courts and the European Court of Human Rights and making our own Supreme Court the ultimate arbiter of human rights matters in the UK. Outlaw groups that forment hate with the introduction of new Banning Orders for extremist organisations.', 'https://www.conservatives.com/manifesto' ] ],
      'Environment' => [ [ 'Spend £3 billion from the Common Agricultural Policy to enhance UK’s countryside. Create a Blue Belt around the UK’s 14 Overseas Territories, subject to local support and environmental need End any new public subsidies for windfarms and give local people the final say on windfarm applications. Invest £500 million over the next five years in work towards zero emission vehicles by 2050.', 'https://www.conservatives.com/manifesto' ] ]
    },
    'Labour Party' => {
    ...
    'Liberal Democrats' => { 
      ...
      'Environment' => [ [ 'Pass a Zero Carbon Britain Act to bring net greenhouse gas emissions to zero by 2050. Expand the Green Investment Bank and set a legally binding decarbonisation target to green our electricity. Establish a statutory waste recycling target of 70%.', 'http://www.libdems.org.uk/read-the-full-manifesto' ] ]
    },
    'Green Party' => {
      'The NHS' => [ [ 'Keep the NHS a public service, comprehensive and free at the point of delivery. Promote transparency by ending commercial confidentiality. Immediately increase the overall NHS budget by £12 billion a year, and thereafter by 1.2% annually in real terms to take account of our ageing population. Repeal the Health and Social Care Act 2012, which is an extensive reorganisation of the NHS.', 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ],
      'Economy and taxes' => [ [ 'Instead of closing deficit as main objective of economic policy, be prepared to borrow for investment. End zero-hours contracts, and increase the minimum wage to a living wage, and phase in 35-hour week. Separate retail and investment banking and introduce a financial transaction tax. Introduce wealth tax of 2% on top 1%, and maximum pay ratio of 10:1 in companies, and raise top rate of income tax to 60%.', 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ],
      'Immigration' => [ [ 'Ensure that no prospective immigrant is held in detention. Assist integration by making available free or affordable English or Welsh language lessons to all new immigrants who want them. Open up ways for existing irregular migrants who have been here for three years to become legal. No immigration restrictions on foreign students, and no priority simply for economic reasons.', 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ],
      'Benefits and pensions' => [ [ "Provide free social care funded by taxation on the same basis as the NHS. Scrap the Help to Buy scheme, which does not help those in greatest housing need. Create 500,000 social rented homes to by increasing the social housing budget to £6b a year. Abolish the bedroom tax and tax deductions for landlords. Introduce a Citizen's Pension in 2016, paying a flat-rate pension regardless of contribution record.", 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ],
      'Law and order' => [ [ 'Require 40% of all members of public company and public sector boards to be women. Lower the voting age to 16 and raise the age of criminal responsibility from 10 to 14. Make higher education free and end the student loan system. Reform the House of Lords to an elected body chosen by proportional representation. Introduce referendums on local government decisions if called for by 20% of the local electorate', 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ],
      'Environment' => [ [ 'Phase out fossil-fuel-based generation by 2023, and nuclear power within ten years. Invest up to £35 billion over the Parliament in renewable generation and in the National Grid. Ban all UK fracking operations. Free nationwide retrofit insulation programme, with focus on areas with fuel poverty. Give tenants the right to require landlords to achieve the same improvement to the energy performance.', 'https://www.greenparty.org.uk/we-stand-for/2015-manifesto.html' ] ]
    },
    'UK Independence Party (UKIP)' => {
      'The NHS' => [ [ 'Invest an extra £12 billion into the NHS. Secure the exclusion of the NHS from TTIP. Increase social care funding by £1.2 billion each year, phasing in this increase over a two-year period. Build a dedicated military hospital. Abolish hospital parking charges.', 'http://www.ukip.org/ukip_manifesto_summary' ] ],
      'Economy and taxes' => [ [ 'End tax on minimum wage, inheritance tax and bedroom tax. Raise the personal allowance to at least £13k, and threshold for paying 40% income tax to £55k. Save £9 billion a year in direct net contributions to the EU budget by leaving the EU. Reduce overseas aid budget from 0.7% to 0.2%, and increase defence budget to 2% of GDP.', 'http://www.ukip.org/ukip_manifesto_summary' ] ],
      'Immigration' => [ [ 'Put a five-year moratorium on immigration for unskilled workers. Introduce an Australian-style points based system to manage number and skills of immigrants. Require all non-UK undergraduate and post-graduate students to maintain private health insurance for the period of their study. Require new migrants to pay tax and NI contributions for five years before accessing benefits or than non-urgent NHS services.', 'http://www.ukip.org/ukip_manifesto_summary' ] ],
      'Benefits and pensions' => [ [ 'Support a lower cap on benefits. Waive tuition fees for students taking a degree in science; technology; engineering; maths or medicine. Train and fund the cost of 800 advisers to work in 800 foodbanks. Introduce a flexible state pension window, so even when the state pension age increases to 69, pensioners will still be able to take a slightly lower weekly state pension from the age of 65.', 'http://www.ukip.org/ukip_manifesto_summary' ] ],
      'Law and order' => [ [ 'Legislate for an initial presumption of 50-50 shared parenting in child residency matters. Adopt a zero tolerance approach to cultural practices that are either illegal or which conflict with British values and customs. Campaign for a new, proportional voting system while retaining a constituency link. Every two years, allow a national referendum, provided the petition has more than two million signatures.', 'http://www.ukip.org/ukip_manifesto_summary' ] ],
      'Environment' => [ [ 'Repeal the Climate Change Act, abolish green taxes and levies, and withdraw from the EU’s Emissions Trading Scheme. Support the development of shale gas, levy Petroleum Revenue Tax (currently 50 per cent) on any shale profits. Drop all subsidies for wind and solar power. Set up a commission to investigate ways to assist and rejuvenate the coal industry.', 'http://www.ukip.org/ukip_manifesto_summary' ] ]
    },
    'Scottish National Party' => {
      'The NHS' => [ [ 'Increase NHS spending by £24b by 2021 (£9.5b over inflation), leading to a £2b increase for Scotland. Oppose NHS privatisation and back moves to restore it to a fully public service.', 'http://votesnp.com/docs/manifesto.pdf' ] ],
      'Economy and taxes' => [ [ 'Increase the minimum wage to £8.70 by 2020, and extend the Living Wage across the UK. Enshrine principles of fiscal policy in law, including elimination of deficit and balanced ‘current account’ spending. End exploitative zero hours contracts, and increase in the Employment Allowance from £2k per business per year to £6k by 2020. Oppose plans for a new generation of Trident nuclear weapons.', 'http://votesnp.com/docs/manifesto.pdf' ] ],
      'Immigration' => [ [ 'Reintroduce the post study work visa so students who have been educated in Scotland can spend 2 years working here after their studies.', 'http://votesnp.com/docs/manifesto.pdf' ] ],
      'Benefits and pensions' => [ [ 'Abolish the bedroom tax, and oppose plans to cuts in Child Benefit, Tax Credits and Winter Fuel Allowance. Increase free childcare to 30 hours per week by 2020. Continue free university education in Scotland and reduce tuition fees across the UK.', 'http://votesnp.com/docs/manifesto.pdf' ] ],
      'Law and order' => [ [ 'Support independence in Scotland. Replace electoral system with proportional representation. Abolish the House of Lords. Push for 50:50 gender representation on public and private boards. Scottish Parliament should move to full financial responsibility. 16 and 17 year olds should be given the vote in UK general and European elections.', 'http://votesnp.com/docs/manifesto.pdf' ]],
      'Environment' => [ [ 'Vote for the UK Government to adopt Scotland’s ambitious carbon reduction targets. Continue to support a moratorium on fracking. Maximise support for offshore wind, including by seeking alterations to the current Contracts for Differences (CFD) regime.', 'http://votesnp.com/docs/manifesto.pdf' ] ]
    },
    'Plaid Cymru' => {
    ...
    'Pirate Party UK' => {
      'The NHS' => [ [ 'We aim to abolish patents on drugs and instead fund research directly, allowing the NHS to reduce its outlay on costly medicines.', 'https://pirateparty.org.uk/policy/health/home' ] ],
      ...
      'Immigration' => [ [ 'The demand for certain skills that are in short supply in the UK has made immigration vitally important for both the public and the private sector. Well-managed and well-controlled immigration is important to ensure that the UK remains competitive and innovative.', 'https://pirateparty.org.uk/policy/social-policy/rational-points-based-immigration-system' ] ],
      'Benefits and pensions' => [ [ 'We believe the current system is failing and needs to be revitalised. A successful welfare system reaches everyone in need. Punitive measures on those who try to exploit the system hurt the needy. We would introduce measures to prevent people receiving unfair blocks on benefits.', 'https://pirateparty.org.uk/policy/welfare-and-work/home' ] ],
      'Law and order' => [ [ 'It often feels like we live in a "say no first, ask questions later" society. Whether it\'s councils banning a 9 year old from blogging about school dinners or the government threatening to suspend social media, the Pirate Party has always stood up for freedom of speech.', 'https://pirateparty.org.uk/policy/civil-liberties/home' ] ],
      'Environment' => [ [ "We need smart policy to improve our environment. The environmental challenges, from dealing with local 'grotspots' to climate change, are monumental. We have a responsibility to look after our environment and wildlife. This requires changes in all parts of our economy and in our behaviour, but if we work together we can deal with both.", 'https://pirateparty.org.uk/policy/environment/home' ] ] },
    'Default' => {
